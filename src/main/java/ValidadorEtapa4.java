...
public class ValidadorEtapa4 {
	...
	public static void main(String[] args){
		...
		System.out.println(loja1.getProdutos().length == 5 ? "[OK] Método Loja.getEstoqueProdutos()" : "[NOK] Método Loja.getEstoqueProdutos()");
		...
		System.out.println(loja2.getProdutos()[1] == null ? "[OK] Método Loja.insereProduto() - restante do array permanece vazio" : "[NOK] Método Loja.insereProduto() - ao incluir um produto, mexeu nas demais posições do array");
